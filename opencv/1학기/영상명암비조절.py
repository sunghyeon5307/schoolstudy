...
# 영상읽기
img1 = cv2.imread("/Users/bagseonghyeon/Desktop/schoolstudy/opencv/images/img5.jpg", cv2.IMREAD_GRAYSCALE)
...
max_v_set=100/np.power(thres2, gamma2)
...
# 결과 영상 출력
titles = ['입력영상', '상수곱', '로그변환', '거듭제곱 변환', '구간변환']
